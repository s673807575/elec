                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <c:forEach items="${a}" var="a">
                            <tr class="odd gradeX">
                                ...
                                <td>${a.devicemess}</td>
                                <td>
                                    <button class="btn btn-primary btn-mini" onclick="javascript:window.location.href='/project/editview?id=${a.id}'">通过</button> <button class="btn btn-danger btn-mini" value="${a.id}">不通过</button>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
