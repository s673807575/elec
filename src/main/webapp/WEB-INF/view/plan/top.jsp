...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        <li class="active li_1"><a href="/plan/query"><i class="icon icon-home"></i> <span>方案</span></a> </li>
        <li class="active li_2"><a href="/plan/queryjob"><i class="icon icon-home"></i> <span>工作</span></a> </li>
